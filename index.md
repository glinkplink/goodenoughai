...
| [src/goodenough_bench/migrations/](src/goodenough_bench/migrations/) | Tracked SQL migrations (`0001_initial.sql`, `0002_batch_purpose.sql`, `0003_model_route_provenance.sql`, `0004_reproduction_checksum.sql`) and statement-complete, checksum-verified migration runner | **Implemented for current persistence schema** |
