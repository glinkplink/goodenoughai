...
> **Authority:** Full records for approved decisions DEC-0001 through DEC-0017  
> **Load when:** An older decision's exact rationale, consequence, or revisit trigger matters  
> **Current decisions:** [DECISION_LOG.md](DECISION_LOG.md) (DEC-0018 onward)  
...
Approved decisions DEC-0001 through DEC-0017. Newer approved decisions supersede older planning text and live in the current decision log.
...
- [DECISION_LOG.md](DECISION_LOG.md) — current decisions (DEC-0018 onward)
