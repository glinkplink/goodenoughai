...
| Model profiles and pricing snapshots | Synthetic repository-controlled JSON under `config/` with strict loaders (`load_model_profiles`, `load_pricing_snapshots`); not verified provider prices |
